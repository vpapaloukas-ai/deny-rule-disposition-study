...
set -u
OUT=$HOME/advtest/gen-c-session-v2
...
THIS service: a mix of small features, bug investigations, refactors, added tests, documentation,
and review/planning work, spread across the roles above. Each task must be concrete enough that one
person could pick it up and finish it in a sitting, and grounded in the service described above.
